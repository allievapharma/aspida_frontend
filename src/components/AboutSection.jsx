...
function AboutSection() {
  return (
    <div className="myFadeup bg-gradient-to-b from-cyan-50 to-white text-gray-800 px-6 py-16 md:px-20">
      {/* Header */}
      ...
      {/* About Section */}
      <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-12 px-4 md:px-8 lg:px-16 py-12 ">
        {/* Image Section */}
        ...
        {/* Text Section */}
        <div className="w-full lg:w-1/2 max-w-5xl shadow-[rgba(0,0,0,0.05)_0px_6px_24px_0px,rgba(0,0,0,0.08)_0px_0px_0px_1px] rounded-2xl p-6 md:p-10 lg:p-12 transition-all duration-700 ease-out animate-fadeInUp">
