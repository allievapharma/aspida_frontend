...
import backgroundtestimonial from "../assets/image/background/components-bg.jpg";
const Testimonial = () => {
  return (
    <div>
      {/* <h1>test</h1> */}
      
      <section className="myFadeup bg-[#E2E0E1] relative overflow-hidden py-12 sm:py-16 lg:py-20">
        <div className="absolute top-10 right-0 overflow-hidden -z-10">
            <img src={backgroundtestimonial} alt="" className="w-[600px]"/>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="relative mt-10 md:mt-24 md:order-2">
              ...
              <div className="relative grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
                <div className="testimonial flex flex-col overflow-hidden shadow-xl">
